...
async function executeWebSearch(query: string): Promise<string> {
  ...
  return `⚠️ No search API configured. Set TAVILY_API_KEY or GOOGLE_SEARCH_API_KEY + GOOGLE_SEARCH_CX.\n\nFor now, reason about what you know about the Chilean experience market for: "${query}". Suggest realistic candidates that would fit thelist.cl.`;
}
